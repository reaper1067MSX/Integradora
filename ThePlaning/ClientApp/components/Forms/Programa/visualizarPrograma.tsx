...
export class visualizarPrograma extends React.Component<{} , State> {
    ...
    public render() {
        ...
        return <div className="container">
            <HeaderForm>
                <TituloForm>Visualizar Programas</TituloForm>
            </HeaderForm>
            <CuerpoForm>
                <Row>
                    ...
                    <Container className='col-md-6'>
                        <NavLink to={'/registroPrograma'} activeClassName='active'> 
