...
export class visualizarLocalidad extends React.Component<{} , State> {
    ...
    public render() {
        ...
        return <div className="container">
            <HeaderForm>
                <TituloForm>Visualizar Localidades</TituloForm>
            </HeaderForm>
            <CuerpoForm>
                <Row>
                    ...
                    <Container className='col-md-6'>
                        <NavLink to={'/registroLocalidad'} activeClassName='active'> 
