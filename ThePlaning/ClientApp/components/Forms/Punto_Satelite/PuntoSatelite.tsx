...
export  class PuntoSatelite extends React.Component<{}, {}> {
    public render() {
                ...
                <div className="col-md-6">
                    <div className="well-block">
                        <div className="well-title">
                            <h2>Registrar Punto Satelite</h2>
                        </div>
                        <form>
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="form-group">
                                        <label className="control-label" placeholder="name">Name</label>
                                ...
                                <div className="col-md-6">
                                        <div className="form-group">
                                        <label className="control-label" placeholder="email">Email</label>
                                ...
                                <div className="col-md-6">
                                            <div className="form-group">
                                        <label className="control-label" placeholder="date">Preferred Date</label>
                                            ...
                                            <div className="col-md-6">
                                                <div className="form-group">
                                        <label className="control-label" placeholder="time">Preferred Time</label>
                                ...
                                <div className="col-md-12">
                                                <div className="form-group">
                                        <label className="control-label" placeholder="appointmentfor">Appointment For</label>
